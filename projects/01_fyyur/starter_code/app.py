...
from forms import *
from flask_migrate import Migrate #  newly add
import sys 
...
app.config['SQLALCHEMY_DATABASE_URI'] = 'postgresql://zhongxiaoyuan:####@localhost:5432/fyyur'
...
class Venue(db.Model):
  __tablename__ = 'venue' # table name should be lowercase, and there shouldn't be empty column
...
class Artist(db.Model):
  __tablename__ = 'artist'# table name should be lowercase
...
class Show(db.Model):
  _tablename__ = 'show' # Model show linked the Model Vuenue and Artist
  id = db.Column(db.Integer, primary_key=True)
...
def create_venue_form():
  app = Flask(__name__) # ?? can this be ignored???
  form = VenueForm()
...
def create_venue_submission():
  ...
  #   abort(500)
  #   body['success'] = False
  #   body['msg'] = 'There is an error!!!! '
  # else:
  #   body['msg'] = 'YESSS!Sucessfully!!!!'
  #   body['success'] = True
  return jsonify(body)
